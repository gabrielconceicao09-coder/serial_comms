...
class SerialImuNode : public rclcpp::Node
{
    ...
    const int64_t passo_ideal = 1000*(1/90.92)*1000000; //período ideal de amostragem, em nanossegundos, para frequência de amostragem observada (Ex: 500 Hz => 2ms, 100 Hz => 10ms)
