...
class SerialSensorsNode : public rclcpp::Node
{
    ...
    void ReadPub_callback()
    {
        ...
        } else RCLCPP_INFO(this->get_logger(), "Sequência GPS menor ou igual à anterior, mensagem não publicada");
        ...
        if (sequencia_sonar>ultima_seq_sonar){
            ...
            if (range1>max_range_sonar_ || range1<0.0){
                range1 = std::numeric_limits<float>::infinity();
                sonarMsg1->range = range1;
            } else if (range1<min_range_sonar_){
                range1 = -std::numeric_limits<float>::infinity();
                sonarMsg1->range = range1;
            } else {
                sonarMsg1->range = range1;
            ...
            if (range2>max_range_sonar_ || range2<0.0){
                range2 = std::numeric_limits<float>::infinity();
                sonarMsg2->range = range2;
            } else if (range2<min_range_sonar_){
                range2 = -std::numeric_limits<float>::infinity();
                sonarMsg2->range = range2;
            } else {
                sonarMsg2->range = range2;
            ...
            if (range3>max_range_sonar_ || range3<0.0){
                range3 = std::numeric_limits<float>::infinity();
                sonarMsg3->range = range3;
            } else if (range3<min_range_sonar_){
                range3 = -std::numeric_limits<float>::infinity();
                sonarMsg3->range = range3;
            } else {
                sonarMsg3->range = range3;
            ...
            if (range4>max_range_sonar_ || range4<0.0){
                range4 = std::numeric_limits<float>::infinity();
                sonarMsg4->range = range4;
            } else if (range4<min_range_sonar_){
                range4 = -std::numeric_limits<float>::infinity();
                sonarMsg4->range = range4;
            } else {
                sonarMsg4->range = range4;
            ...
            if (range5>max_range_sonar_ || range5<0.0){
                range5 = std::numeric_limits<float>::infinity();
                sonarMsg5->range = range5;
            } else if (range5<min_range_sonar_){
                range5 = -std::numeric_limits<float>::infinity();
                sonarMsg5->range = range5;
            } else {
                sonarMsg5->range = range5;
